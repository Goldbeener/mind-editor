<template>
  <div class="not-prose h-full relative bg-slate-50 overflow-auto dark:bg-slate-800/25">
    <div
      class="absolute inset-0 bg-grid-slate-100 [mask-image:linear-gradient(0deg,#fff,rgba(255,255,255,0.6))] dark:bg-grid-slate-700/25 dark:[mask-image:linear-gradient(0deg,rgba(255,255,255,0.1),rgba(255,255,255,0.5))]"
      style="background-position: 10px 10px;"
    />
    <div class="relative h-fulls p-8">
      <div class="relative">
        <div
          class="absolute inset-0 -top-8 -bottom-8 hidden sm:grid grid-cols-[1fr,2rem,1fr,2rem,1fr]"
        >
          <div class="opacity-75 w-full h-full" />
          <div class="bg-stripes-blue opacity-75 h-full" />
          <div class="opacity-75 w-full h-full" />
          <div class="bg-stripes-blue opacity-75 h-full" />
          <div class="opacity-75 w-full h-full" />
        </div>
        <div class="relative columns-1 sm:columns-3 gap-8">
          <div class="relative aspect-w-16 aspect-h-9">
            ...
            >
            <div class="absolute inset-0 ring-1 ring-inset ring-black/10 rounded-lg" />
          </div>
